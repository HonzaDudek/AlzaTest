export const expiredGroupMockData = {
  data: {
    self: {
      href:
        'https://www.alza.cz/api/socialShopping/v1/groups/be9c1f54-2364-4d9f-babc-1068b76e1174',
      appLink: 'socialShoppingGroup',
    },
    participants: null,

    hash: 'be9c1f54-2364-4d9f-babc-1068b76e1174',
    status: 2,
    commodity: {
      self: {
        href: 'https://www.alza.cz/api/socialShopping/v1/commodities/4844942',
        appLink: 'socialShoppingProduct',
      },
      id: 4844942,
      img: 'https://cdn.alza.cz/ImgW.ashx?fd=f10&cd=OPT007c',
      discountPrice: '8,-',
    ...
    groupSize: 2,
    capacityLeft: 1,
    capacityLeftText: 'Zbývají 1 místa',
    capacityLeftTextDecorated: '1 místa',
    shareUrl: '',
    ...
    addToBasketAction: {
      ...
      form: {
        ...
        rel: ['form'],
        href: 'https://www.alza.cz/api/basket/v1/items',
      },
    },
