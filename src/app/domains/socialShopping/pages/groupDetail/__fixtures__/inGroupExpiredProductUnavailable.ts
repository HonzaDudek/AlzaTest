export const inGroupExpiredProductUnavailableMockData = {
  data: {
    self: {
      href:
    ...
    groupSize: 5,
    capacityLeft: 3,
    capacityLeftText: 'Tým je plný',
    capacityLeftTextDecorated: 'Tým je plný',
    shareUrl: '',
    shareTitleText:
    ...
    redirectProductDetailAction: {
      href:
        'https://legolas.alza.cz/services/restservice.svc/v13/product/5459001',
      appLink: 'catalogProductDetail',
      name: 'Podrobnosti o zboží',
    },
    redirectOrderDetailAction: {
      href: 'https://legolas.alza.cz/api/users/9997534/v1/orders/420576978',
      appLink: 'orderDetail',
    ...
    texts: {
      ...
      groupDetailTitle: 'Jste členem týmu.',
      groupDetailTitleDecorated: 'Akce Skončila',
      groupDetailHeadDescription:
        'Je nám líto. Platnost týmové slevy vypršela a již se k ní nedá připojit. Zboží již není v nabídce.',
