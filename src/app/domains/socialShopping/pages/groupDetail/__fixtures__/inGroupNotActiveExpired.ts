export const inGroupNotActiveExpiredMockData = {
  data: {
    self: {
      href:
    ...
    addToBasketAction: {
      ...
      form: {
        ...
        rel: ['form'],
        href: 'https://legolas.alza.cz/api/basket/v1/items',
      },
    },
    ...
    texts: {
      ...
      groupDetailHeadDescription:
        'Je nám líto. Platnost slevy Sdílej a ušetři vypršela a již se k ní nedá připojit. Vytvořte nový tým a sežeňte dostatek zájemců. Nebo kupte zboží za běžnou cenu.',
