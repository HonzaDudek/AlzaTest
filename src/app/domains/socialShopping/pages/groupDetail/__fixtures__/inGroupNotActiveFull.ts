export const inGroupNotActiveFullMockData = {
  data: {
    self: {
      href:
    ...
    isInStock: true,
    texts: {
      commonTitle: 'Připojte se, sdílejte \n a ušetřete 150 Kč',
      commonTitleDecorated: 'ušetřete 150 Kč',
      groupDetailTitle: 'Jste členem. Splněno! \n Sleva byla aktivována.',
      groupDetailTitleDecorated: 'Splněno!',
